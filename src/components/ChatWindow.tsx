      ...
      <header className={`pl-4 sm:pl-6 pr-14 py-4 border-b flex items-center justify-between sticky top-0 z-10 backdrop-blur-md ${
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          <button 
            ...
            className="flex items-center gap-x-4 bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2 sm:px-4 rounded-xl text-xs sm:text-sm font-bold shadow-md transition-all active:scale-95"
          >
